...
export default function MessageInput(props: propsType): JSX.Element {
    return (
        <div className={`${styles.mainContainer} flex w-4/5 mx-auto`}>
            ...
            <div className=''><Button onClick={props.sendMessageFunction} customTW='bg-gray-50 dark:bg-gray-700 hover:bg-pink-800 px-4 py-2 ml-2 mt-2'><div className=''>Send</div></Button></div>
        </div>
    )
}