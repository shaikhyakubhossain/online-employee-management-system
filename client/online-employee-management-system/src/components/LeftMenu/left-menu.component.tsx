    ...
    <div>
      <div>
        <div
          ...
          } fixed top-20 left-0 bottom-0 flex flex-col justify-between w-60 shadow-2xl bg-white overflow-y-scroll transition-transform duration-300`}
        >
          <div>
          ...
          <div className="flex justify-center items-center gap-4 p-2 text-slate-500 text-xs">
            <div><Link href={"/TermsOfService"}>Terms of service</Link></div>
